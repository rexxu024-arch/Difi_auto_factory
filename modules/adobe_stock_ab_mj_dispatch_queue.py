        ...
        row.update(
            {
                ...
                "Recommended_Format": "JPEG 3:2, MJ relaxed draft grid first, selected U/2x only after Rex approves",
                "MJ_Master_Prompt": clean(source.get("MJ_Prompt")),
                "QA_Gate": "NO_TEXT_NO_LOGO_NO_PEOPLE; MACRO_DEPTH_REQUIRED; 4MP_MIN_AFTER_UPSCALE; ADOBE_AI_DISCLOSURE_REQUIRED",
                "Output_Folder": f"Output/Adobe_Stock/Codex_AB/{sku}",
                "Review_Note": clean(source.get("Strategy")),
                "Upscale_Policy": "NO_UPSCALE_DRAFT_GRID_ONLY_UNTIL_REX_APPROVES_ARM",
